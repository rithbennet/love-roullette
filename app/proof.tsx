...
export default function ProofPhaseScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Text style={styles.heading}>Proof Phase</Text>
            <Text style={styles.phase}>Current Phase: {phase}</Text>
            <Text style={styles.body}>
                {activePlayer ? `${activePlayer.name} is proving their love.` : 'No active player found.'}
            </Text>

            <View style={styles.outcomeBox}>
                <Text style={styles.label}>Outcome</Text>
                <Text style={styles.outcome}>{latestOutcome ?? 'Awaiting proof summary...'}</Text>
            </View>
